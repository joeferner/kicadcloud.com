...
module.exports = function(app) {
  ...
  app.get('/user/:id/projects', app.withConnection(getUserProjects));
  ...
  function getUserProjects(req, res, next) {
    ...
    models.Project.findByUserId(req.conn, userId, function(err, projects) {
      if (err) {
        return next(err);
      }
      return res.render('project/list.ejs', {
        layout: null,
        items: projects
      });
    });
