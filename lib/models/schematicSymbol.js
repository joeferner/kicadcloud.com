...
var SchematicSymbol = module.exports = persist.define("SchematicSymbol", {
  "title": type.STRING,
...
SchematicSymbol.findRecent = function(conn, callback) {
...
SchematicSymbol.findById = function(conn, user, id, callback) {
  var queries = {
...
SchematicSymbol.save = function(conn, id, user, data, callback) {
...
SchematicSymbol.new = function(user) {
  return {
    id: 'new',
    title: 'New',
    code: '',
...
SchematicSymbol.vote = function(conn, id, user, state, callback) {
  var vote;
  if (state === 'up') {
    vote = 1;
  } else if (state === 'down') {
...
SchematicSymbol.favorite = function(conn, id, user, state, callback) {
